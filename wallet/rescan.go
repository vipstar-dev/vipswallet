...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]vipsutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []vipsutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []vipsutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]vipsutil.Address, len(unspent))
