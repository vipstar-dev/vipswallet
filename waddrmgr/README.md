...
[![GoDoc](https://godoc.org/github.com/vipstar-dev/vipswallet/waddrmgr?status.png)]
(http://godoc.org/github.com/vipstar-dev/vipswallet/waddrmgr)
...
http://localhost:6060/pkg/github.com/vipstar-dev/vipswallet/waddrmgr

## Installation

```bash
$ go get github.com/vipstar-dev/vipswallet/waddrmgr
```
