...
func (m *Manager) MarkUsed(ns walletdb.ReadWriteBucket, address vipsutil.Address) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
...
func (m *Manager) AddrAccount(ns walletdb.ReadBucket,
	address vipsutil.Address) (*ScopedKeyManager, uint32, error) {
...
func (m *Manager) ForEachActiveAddress(ns walletdb.ReadBucket, fn func(addr vipsutil.Address) error) error {
	m.mtx.RLock()
	defer m.mtx.RUnlock()
