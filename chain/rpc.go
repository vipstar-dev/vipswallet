...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []vipsutil.Address,
...
func (c *RPCClient) onRecvTx(tx *vipsutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *vipsutil.Tx, block *btcjson.BlockDetails) {
