...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="vipswallet RPC"`)
...
// method.  This may be a request that is handled directly by vipswallet, or
// a chain server request that is handled by passing the request down to vipsd.
//
